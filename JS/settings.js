// Dark mode toggle (switch + navbar icon dono sync rahenge)
...
document.getElementById('clearDataBtn').addEventListener('click', () => {
  const confirmClear = confirm('Are you sure? This will permanently delete all transactions and goals.');
  if (confirmClear) {
...
currencySelect.addEventListener('change', () => {
  ...
  alert('Currency updated! Visit Dashboard to see amounts converted.');
});
...
if (localStorage.getItem('userName')) editName.value = localStorage.getItem('userName');
if (localStorage.getItem('userEmail')) editEmail.value = localStorage.getItem('userEmail');
